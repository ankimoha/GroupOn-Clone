    ...
    public String view() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //  
//                additem = additem + rs.getString("Category") + " " + rs.getString("itemName") + " " + rs.getInt("itemAvailable")+"<br/>";
                itemlist.add(new Item(rs.getString("Category"),rs.getString("itemName"), rs.getInt("itemAvailable")));
            }
            return additem;
//            else{
